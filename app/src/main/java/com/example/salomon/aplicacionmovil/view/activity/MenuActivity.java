...
public class MenuActivity extends BaseActivity {
    ...
    @BindView(R.id.menu_drawer_layout) DrawerLayout drawer;
    ...
    private void loadNavHeader() {
        // name, website
        txtName.setText("Salomon Memenza Ccaccya");
        txtWebsite.setText("www.google.com/salomemenza");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_logout) {
            Toast.makeText(getApplicationContext(), "Fin de sesión", Toast.LENGTH_SHORT).show();
            return true;
        }
